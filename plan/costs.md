# 💰 Kosztorys Wyprawy — Islandia 16-22.09.2026

Przelicznik przyjęty w kalkulacji: **100 ISK ≈ 2.90 PLN** (1 PLN ≈ 34.5 ISK).
Profil wyjazdu: studencki, optymalny kosztowo, namioty, gotowanie z palnika, 1 posiłek w restauracji.

---

## 1. Koszty Wspólne (Dzielone na 4 Osoby)
...
## 2. Koszty Indywidualne (Płatne Per Osoba)
...
## 4. Porównanie Wariantów Budżetowych

| Wariant | Koszt na osobę | Główne różnice |
|---|---|---|
| **Opcja Ultra-Low-Cost** | **~3 250 PLN** | Rezygnacja z wycieczki na lodowiec z przewodnikiem (tylko spacer pod czoło), zero basenów termalnych, zero restauracji (tylko Huel/Bónus). |
| **Opcja Rekomendowana (Standard Studencki)** | **~3 755 PLN** | Z trekkingiem na lodowcu Vatnajökull (must-have!), 2 lokalnymi basenami termalnymi (Vík + Keflavík), 1 tradycyjnym obiadem w stolicy. |
| **Opcja Komfort (z luksusem)** | **~4 150 PLN** | Opcja Rekomendowana + wstęp do Sky Lagoon Pure Pass (~200 PLN) zamiast basenu w Keflavíku + dodatkowa kolacja. |
